...
function cumlelereDonustur(cumleler, ikinci = ",") {
  let sonuc = cumleler.map((cumle) => cumle.join(ikinci));
  return sonuc
}
...
function paragrafOlustur(cumleler, cumleKur, cumlelereDonustur) {
  ...
  let cümle = ""
  cümle = cumleKur(dizi[1], dizi[3], dizi[5], dizi[7], dizi[9])
  return cümle
}
...
//console.log(emojileriDonustur("asdf:D", emojiler))
